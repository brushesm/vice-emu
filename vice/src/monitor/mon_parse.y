...
%token CMD_WARP
%token CMD_PROFILE FLAT GRAPH FUNC DEPTH DISASS PROFILE_CONTEXT CLEAR PROFILE_EXPORT FORMAT_CSV FORMAT_CALLGRIND
...
monitor_misc_rules: CMD_DISK rest_of_line end_cmd
                  ...
                  | CMD_PROFILE PROFILE_EXPORT FORMAT_CSV STRING end_cmd
                     { mon_profile_export_csv($4); }
                  | CMD_PROFILE PROFILE_EXPORT FORMAT_CALLGRIND STRING end_cmd
                     { mon_profile_export_callgrind($4); }
                  ;
